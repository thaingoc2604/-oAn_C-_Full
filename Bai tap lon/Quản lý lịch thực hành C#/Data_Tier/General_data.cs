...
namespace Data_Tier
{
    ...
    {
        //kết nối database
        public OleDbConnection cnn = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB\\dbThiTracNghiem_THDC.accdb;Persist Security Info=True");
        ...
        public void CapNhatDuLieu(DataTable tbTable, string strTableName)
        {
            ...
            {
                throw new Exception("Ban Loi cap nhat " + err);
            }
        }

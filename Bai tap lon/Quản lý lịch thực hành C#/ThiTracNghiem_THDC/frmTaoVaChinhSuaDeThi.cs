...
namespace ThiTracNghiem_THDC
{
    public partial class frmTaoVaChinhSuaDeThi : Form
    {
       ...
       private int cautraloi = 0;
        ...
        {
            lblGio.Text = DateTime.Now.Hour.ToString() + " h: " + DateTime.Now.Minute.ToString() + " m: " + DateTime.Now.Second.ToString() + " s";
        }

        private void frmTaoVaChinhSuaDeThi_Load(object sender, EventArgs e)
        {
            lblNgay.Text ="Hôm nay. Ngày " + DateTime.Now.Day.ToString() + ", tháng " + DateTime.Now.Month.ToString() + ", năm " + DateTime.Now.Year.ToString();

   ...
   public class Donvitinhdata
    {
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM DONVITINH ");
            m_DanhmucTS.Load(cmd);
            return m_DanhmucTS;
        }
        public DataTable MaDonViTinh(String id)
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM DONVITINH WHERE MADONVITINH=@id ");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM DONVITINH WHERE MADONVITINH LIKE N'%" + makh + "%'");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM DONVITINH WHERE TENDONVITINH LIKE N'%" + tenkh + "%'");

   ...
   public class Nhomtaisandata
    {
        ...
        public DataTable DanhSachNhomTaiSan()
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM NHOMTAISAN ");
            m_DanhmucTS.Load(cmd);
            return m_DanhmucTS;
        }
        public DataTable MaNhomTaiSan(String id)
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM NHOMTAISAN WHERE MANHOMTAISAN=@id ");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM NHOMTAISAN WHERE MANHOMTAISAN LIKE N'%" + makh + "%'");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM NHOMTAISAN WHERE TENNHOMTAISAN LIKE N'%" + tenkh + "%'");

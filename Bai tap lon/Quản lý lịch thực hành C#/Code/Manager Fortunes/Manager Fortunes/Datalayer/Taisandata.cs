...
{
   public  class Taisandata
    {
        SqlCommand sqlCommand;
        DataService m_DanhmucTS = new DataService();
        public DataTable DanhSachTaiSan()
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM TAISAN ");
            m_DanhmucTS.Load(cmd);
            return m_DanhmucTS;
        }
        public DataTable MaTaiSan(String id)
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM TAISAN WHERE MATAISAN=@id ");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM TAISAN WHERE MATAISAN LIKE N'%" + makh + "%'");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM TAISAN WHERE Tenloaikhachhang LIKE N'%" + tenkh + "%'");

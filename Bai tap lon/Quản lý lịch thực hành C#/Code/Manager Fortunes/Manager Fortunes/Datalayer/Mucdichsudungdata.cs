...
{
   public class Mucdichsudungdata
    {
        SqlCommand sqlCommand;
        DataService m_DanhmucTS = new DataService();
        public DataTable DanhSachMucDichSuDung()
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM MUCDICHSUDUNG ");
            m_DanhmucTS.Load(cmd);
            return m_DanhmucTS;
        }
        public DataTable MaMucDichSuDung(String id)
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM MUCDICHSUDUNG WHERE MAMUCDICHSUDUNG=@id ");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM MUCDICHSUDUNG WHERE MAMUCDICHSUDUNG LIKE N'%" + makh + "%'");
        ...
        {
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM MUCDICHSUDUNG WHERE TENMUCDICHSUDUNG LIKE N'%" + tenkh + "%'");

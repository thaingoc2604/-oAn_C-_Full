...
namespace QLXM_8
{
    public partial class RPBanhang : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Report\Banhang_full.rpt");
        ...
        {
            ReportDocument cryRpt = new ReportDocument();
            cryRpt.Load(Application.StartupPath + @"\Report\Banhang_ngay.rpt");
        ...
        {
            ReportDocument cryRpt = new ReportDocument();
            cryRpt.Load(Application.StartupPath + @"\Report\Banhang_nhomxe.rpt");

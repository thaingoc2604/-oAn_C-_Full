...
namespace TT_GDTX_ANGIANG.BusinessObject
{
    public class KhenThuongInfo
    {
        ...
        public KhenThuongInfo(String maQTTS,string maNV, SoQuyetDinhInfo soQD, DateTime ngayQD, String coQuanKT, String hinhThucKT, String lyDoKT, String nguoiKy, String ghiChu)
        {
            MaQuaTrinhKhenThuong = maQTTS;
            MaNhanVien = maNV;
            SoQuyetDinh = soQD;
            NgayQuyetDinh = ngayQD;
            CoQuanKhenThuong = coQuanKT;
            HinhThuc = hinhThucKT;
            LyDo = lyDoKT;
            NguoiKy = nguoiKy;
            GhiChu = ghiChu;
        ...
        public KhenThuongInfo(String maQTKT, String coQuanKT)
        {
            MaQuaTrinhKhenThuong = maQTKT;
            CoQuanKhenThuong = coQuanKT;
        }
        #endregion
        ...
        public string MaQuaTrinhKhenThuong
        {
            get { return m_QTKT; }
            set { m_QTKT = value; }
        }
        ...
        #region COQUANKHENTHUONG
        private String m_COQUANKHENTHUONG;
        public String CoQuanKhenThuong
        {
